...
--    locales = [ LocaleTag "en-US" ]
--
--    fmtError = createDateTimeFormat [ LocaleTag "" ] opts
--      where
...
--      let
--        fmtDate1 = formatJSDate fmtWeekdayYearMonthDayHourMinuteSecond d
--
...
--        == fmtDate1Expected
--      let
--        fmtDate2 = formatJSDate fmtWeekdayYearMonthDay d
--
...
--        == fmtDate2Expected
--      let
--        fmtDate3 = formatJSDate fmtYearMonthDay d
--
...
--        == fmtDate3Expected
--      let
--        fmtDate4 = formatJSDate fmtYearMonth d
--
...
--        == fmtDate4Expected
--      let
--        fmtDate5 = formatJSDate fmtMonthDay d
--
...
--        == fmtDate5Expected
--      let
--        fmtDate6 = formatJSDate fmtHourMinuteSecond d
--
...
--        == fmtDate6Expected
--      let
--        fmtDate7 = formatJSDate fmtHourMinute d
--
...
--        == fmtDate7Expected
--      let
--        fmtDate8 = formatJSDate fmtEraYear d
--
...
--        == fmtDate8Expected
--      let
--        fmtDate9 = formatJSDate fmtEra d
--
...
--        == fmtDate9Expected
--      let
--        slocs = supportedLocalesOf [ "en-US", "jp-JP" ]
--      assert' ("supportedLocalesOf: got: " <> show slocs) $ slocs == Right [ "en-US" ]
--      let
--        err = supportedLocalesOf [ "en_US" ]
